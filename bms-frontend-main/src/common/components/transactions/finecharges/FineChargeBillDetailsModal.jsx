...
export default function FineChargeBillDetailsModal({
    isOpen,
    bill = null,
    onClose,
    ...
    const summary = useMemo(() => {
        ...
        return {
            ...
            receipt,
            description: bill.charge_description ?? bill.bill_desc,
            chargeDate: formatDateOnly(bill.charge_date),
    ...
    const handleOpenReceipt = async () => {
        ...
        try {
            const resp = await apiService.getFineChargeReceipt({id: bill.id});
    ...
    const handleConfirmCancel = async (values) => {
        ...
        try {
            const resp = await apiService.cancelFineChargeBill({
                id: bill.id,
    ...
    return (
        <>
            ...
            >
                <BrandModalHeader title="Fine Charge Bill" onClose={handleClose} />
                    ...
                    <>
                        <div className="max-h-[70vh] overflow-y-auto px-6 py-5">
                            ...
                            <div className="mb-5 grid grid-cols-1 gap-x-6 sm:grid-cols-2">
                                ...
                                <ReadOnlyField label="Charge Date" value={summary.chargeDate} />
                    ...
                    <div className="px-6 py-5">
                        <div className="mb-4 rounded-md border border-amber-200 bg-amber-50 px-4 py-3">
                            <p className="text-sm text-amber-900">
                                This will cancel the fine charge bill. Continue?
                            </p>
                        </div>
                        <Form.Item
                            name="cancel_reason"
...
FineChargeBillDetailsModal.propTypes = {
