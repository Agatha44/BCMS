...
const ModuleRoleForm = ({ onSubmit, onCancel, initialValues }) => {
  ...
  useEffect(() => {
    if (initialValues) {
      form.setFieldsValue({
        ...
        module_ids: initialValues.module_ids || [],
      });
    } else {
      form.resetFields();
    }
  ...
  return (
    <Form
      ...
      initialValues={{ module_ids: [], ...initialValues }}
      autoComplete="off"
      ...
      <Row gutter={[16, 16]}>
        <Col span={24}>
          ...
          >
            <Select
              mode="multiple"
              placeholder="Select modules (one role can have multiple modules)"
...
ModuleRoleForm.propTypes = {
  onSubmit: PropTypes.func,
  onCancel: PropTypes.func,
  initialValues: PropTypes.object
};

export default ModuleRoleForm;
